...
# Total folders in 'data'        : 2 (images, videos)

# Total images in 'data/images'  : 10 images

# Total videos in 'data'         : 1

# Total notebooks in 'Notebooks' : 5 Notebooks

# Total files in 'Script_file'   : 31 '.py' files and 1 empty result folder
...
2. Notebooks: This folder contains all the notebooks which you practised on online labs. You can
run these notebooks in your local environment using Jupyter Notebook.

3. Script Files: This folder contains python files(.py) which you can run by either using any IDE
like PyCharm etc. or running it through command prompt. 
