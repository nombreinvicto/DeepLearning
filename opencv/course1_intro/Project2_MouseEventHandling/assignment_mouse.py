...
def draw_rectangle(event, x, y, flags, user_data):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        # mark the top-left
        cv2.circle(image, top_left_corners,
        ...
        h = bottom_right_corners[1] - top_left_corners[1]
        w = bottom_right_corners[0] - top_left_corners[0]

        print("h: ", h)
        print("w: ", w)

        cropped = image[top_left_corners[1]: top_left_corners[1] + h,
                  top_left_corners[0]: top_left_corners[0] + w]
